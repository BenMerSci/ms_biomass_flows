...
Model ranking and the $\text{R}²$ suggest the single species saturating model (model 3) is better than model 2 and 4, but the difference is hardly significant both from statistics (Table @tbl:table_ranking) and graphical representation (figure @fig:oneone_plot).
